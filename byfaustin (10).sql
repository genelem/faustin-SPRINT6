...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-04-2022 a las 08:37:00
...
(5, 'BOLSO FAUSTINE', 'CUERO Piel  ', 'interior CUERO ECOLOGICO RESISTENCE', 28000, 1, 6, 2, 15, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'CARTERA BRIGIT ', 'CUERO PIEL SUPREMI', 'manija trenzada', 38000, 4, 5, 1, 20, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(1, 5, 4, 600, 'remito de los 600 para producto id 4'),
(2, 7, 4, 600, 'remito de los 600 para producto id 4'),
(3, 5, 5, 500, 'remito.11111111111111111111111111'),
(4, 6, 5, 500, 'remito.11111111111111111111111111'),
(5, 4, 6, 310, 're.33333333333'),
(6, 5, 6, 310, 're.33333333333'),
(7, 3, 7, NULL, NULL),
(8, 5, 7, NULL, NULL),
(9, 2, 8, NULL, NULL),
(10, 7, 8, NULL, NULL),
